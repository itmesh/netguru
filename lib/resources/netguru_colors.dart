...
abstract class NetguruColors {
  ...
  static const dtBackground = Color(0xFF4B4B4B);
  static const dtPrimary = Color(0xFF2B2B2B);
  static const dtSheet = Color(0xFF2B2B2B);
  static const dtSecondary = Color(0xFFFCFCFC);
}
